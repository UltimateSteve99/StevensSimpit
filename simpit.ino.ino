...
int lastButtonStateSASP=lastButtonState;
...
void loop() {
 ...
 //   mySimpit.activateAction(SAS_ACTION);
  //}
  //if (!sas_switch_stateP && (currentActionStatus & SAS_ACTION)) {
  //  mySimpit.printToKSP("Desactivate Pilot SAS!");
  //  mySimpit.deactivateAction(SAS_ACTION);
  //}


//New SAS but as a button

  int readingSASP = digitalRead(SASP);
  int readingSASCop = digitalRead(SASCop);
  ...
  } else if (!rcs_switch_state && (currentActionStatus & RCS_ACTION)) {
